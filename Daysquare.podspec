#
#  Be sure to run `pod spec lint Daysquare.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Cyandev"
  # s.authors            = { "Cyandev" => "unixzii@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Cyandev"
